...
<body>
  ...
  <nav class="wow-navbar d-flex align-items-center justify-content-center py-3 mb-4 position-relative" style="background:transparent;font-family:'Josefin Sans',sans-serif;">
    ...
    <div class="d-flex gap-4">
      ...
      <a href="trilhas.php" class="wow-nav-link px-4 py-2 rounded-4 text-decoration-none active" style="color:#fff;background:#5fc4b0;font-weight:600;box-shadow:0 2px 8px #0001;transition:all .4s cubic-bezier(.77,0,.18,1);position:relative;">
        Trilhas
        <span class="wow-underline"></span>
      </a>
  ...
  <footer class="container py-4 text-muted small">
    <div class="d-flex justify-content-between align-items-center">
      <div>© PrimeLanguage</div>
      <div>Política • Termos • Contato</div>
    </div>
  </footer>
